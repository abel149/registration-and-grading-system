                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ">
                        <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a class="nav-bnt btn btn-light nav-link" href="#vision-about">Register</a>
                          </li>
                          <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-bnt btn btn-light nav-link log" href="login/index.html">Logout<i class="fa-solid fa-user-plus"></i></a> 
                        </li>
                    </ul> 
                    </div>               
          </nav>  
